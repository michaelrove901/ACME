...
<div class="container">
    <div class="row">
        <div class="col-sm-12" >
        <center>
        <h1><b>Registrar Un Nuevo Propietario</b> </h1><br>
    </center>
    ...
    <br>
    <form onsubmit="return Validar();" method="POST" action="<?= url ?>propietario/nuevoPropietario">
        
    <div class="form-group col-sm-3">
            <label for="documento"># Documento :</label>
            <input class="form-control" type="nomber" name="documento" id="documento"required>
        </div>
        <div class="form-group col-sm-3">
        ...
        <div class="form-group col-sm-12">
            ...
            <center>
                ...
                <a type="reset" class="btn btn-warning" href="<?= url ?>propietario/vw_Propietario">Atras</a>
            </center>
        </div>

...
<div class="container-fluid">
        ...
        <?php foreach ($con as $key => $value) { ?>
            <div class="com-sm-12">
                <center>
            <h1>Información Detallada Del Conductor: <b><?= $value['primerNombre'] ?> <?= $value['segundoNombre'] ?> <?= $value['apellido'] ?></b></h1><br><br>
            ...
            <div class="form-group col-sm-2">
                ...
                <input class="form-control" type="text" name="idConductor" id="idConductor" readonly value="<?= $value['idConductor'] ?>" />
            </div>
